...
Two drafts are available for review:

- [FND-001: Login, access, and account lifecycle](part-foundations/FND-001-login-access-and-account-lifecycle.md)
- [SAML-001: The first complete SP-initiated login](part-saml/SAML-001-first-sp-initiated-login.md), the reviewed pilot

The other 62 lessons are Planned, not yet written. The table of contents distinguishes **Planned**, **Draft**, and **Ready** material. No lesson is labeled Ready merely because its file exists.
