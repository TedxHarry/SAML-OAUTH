...
- [FND-002: Following the browser and its sessions](part-foundations/FND-002-following-the-browser-and-its-sessions.md) · Ready
- [FND-003: Who creates each artifact, and who consumes it?](part-foundations/FND-003-artifact-creators-and-consumers.md) · Draft
- [SAML-001: The first complete SP-initiated login](part-saml/SAML-001-first-sp-initiated-login.md) · Draft, the reviewed pilot

The other 60 lessons are Planned, not yet written. The table of contents distinguishes **Planned**, **Draft**, and **Ready** material. No lesson is labeled Ready merely because its file exists.
